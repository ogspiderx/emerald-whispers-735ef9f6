...
const textLines = [
  ...
  { text: "You've survived 30 days of me 😈", font: "font-dancing", size: "text-xl md:text-3xl" },
  { text: "I know we argue.", font: "font-dancing", size: "text-2xl md:text-4xl" },
  { text: "I know I can be annoying.", font: "font-dancing", size: "text-2xl md:text-4xl" },
  { text: "But I want you to know this...", font: "font-dancing", size: "text-2xl md:text-4xl" },
  { text: "Your laugh hits deeper than music.", font: "font-dancing", size: "text-2xl md:text-4xl" },
  { text: "Your stubbornness? Even that I love.", font: "font-dancing", size: "text-xl md:text-3xl" },
  { text: "The way you say \"idiot\" makes me smile.", font: "font-dancing", size: "text-xl md:text-3xl" },
  { text: "You're the only person I want to fight and fix with.", font: "font-dancing", size: "text-lg md:text-2xl" },
  { text: "You calm my storms and cause them too.", font: "font-dancing", size: "text-2xl md:text-4xl" },
  { text: "You're my peace.", font: "font-dancing", size: "text-3xl md:text-5xl" },
  { text: "My chaos.", font: "font-dancing", size: "text-3xl md:text-5xl" },
  { text: "My person.", font: "font-dancing", size: "text-4xl md:text-6xl" },
  { text: "This isn't a message.", font: "font-dancing", size: "text-xl md:text-3xl" },
  { text: "This is a movie for you.", font: "font-dancing", size: "text-xl md:text-3xl" },
  { text: "A moment you can replay forever.", font: "font-dancing", size: "text-2xl md:text-4xl" },
  { text: "Because forever?", font: "font-dancing", size: "text-2xl md:text-4xl" },
  { text: "Isn't long enough for us.", font: "font-dancing", size: "text-2xl md:text-4xl" },
  { text: "💚", font: "font-dancing", size: "text-6xl md:text-8xl" },
